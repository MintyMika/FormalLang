...
#For all code below, I am assuming that the user is intelligent and will only input strings that are valid
...
def MWGC():
    ...
    while len(input_string) > 0:
        ...
        if current_state in final:
            ...
            input_string = input("Any other guesses?")
        else:
            print("String Denied.")
            input_string = input("Any other guesses?")
...
def BasicallyMod7():
    ...
    while len(inputString) > 0:
        ...
        if currentState in F:
            print("String Accepted!")
            inputString = input("Any other guesses?")
        else:
            print("String Denied")
            inputString = input("Any other guesses?")
